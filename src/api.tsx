...
const baiduAppSecret = preferences.baiduAppSecret.trim().length > 0 ? preferences.baiduAppSecret.trim() : defaultBaiduAppSecret;
...
export async function fetchChineseEmojiTrans(queryText: string): Promise<any> {
    ...
    return axios.get('https://zhongwenzidian.18dao.cn/to-emoji/' + text
    ).catch(err => {
